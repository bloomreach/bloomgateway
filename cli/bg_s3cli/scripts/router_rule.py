...
class RouterRule(ModuleRule):
  """
  Rule definition for Router Module
  """
  endpoint = "endpoint"
  ...
  def build(self):
    ...
    rule[RouterRule.endpoint] = self.rule_data[module_rule_utils.rule_endpoint]
